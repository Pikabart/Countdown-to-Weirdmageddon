...
NCountry = {
	...
	MAX_INTELLIGENCE_CONVOY_DATA_DEVIATION = 0.3,	-- (Old Intel) Max deviation in estimfating enemy convoys amount ( 0.0 - 1.0 )
	...
	MIN_MANPOWER_RATIO = 0.15,						-- Min manpower ratio to show manpower alert. Vanilla is 0.15
...
NAI = {
	...
	WANTED_UNITS_MANPOWER_DIVISOR = 2000,                     -- Normalizing divisor for AI manpower. (below this they will be careful making more divisions, above they want more)
